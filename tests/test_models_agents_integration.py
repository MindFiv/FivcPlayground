...
from fivcplayground.legacies.agents import (
...
class TestAgentsModuleImports:
    ...
    def test_agents_init_imports_from_models(self):
        """Test agents/__init__.py imports from fivcplayground.legacies.models."""
        import fivcplayground.legacies.agents as agents_module
...
class TestDefaultAgentModelUsage:
    ...
    @patch("fivcplayground.legacies.agents.create_default_model")
    @patch("fivcplayground.legacies.agents.tools")
...
class TestCompanionAgentModelUsage:
    ...
    @patch("fivcplayground.legacies.agents.create_chat_model")
    @patch("fivcplayground.legacies.agents.tools")
...
class TestToolingAgentModelUsage:
    ...
    @patch("fivcplayground.legacies.agents.create_reasoning_model")
    @patch("fivcplayground.legacies.agents.tools")
...
class TestModelMigrationBackwardCompatibility:
    ...
    def test_models_module_is_package(self):
        ...
        import fivcplayground.legacies.models as models
    ...
    def test_backends_accessible(self):
        ...
        from fivcplayground.legacies.models.backends.langchain import create_model
