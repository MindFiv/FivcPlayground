...
from fivcplayground.legacies.app.utils import Chat, ChatManager
from fivcplayground.legacies.agents.types import (
    AgentsRuntime,
    AgentsStatus,
    AgentsRuntimeMeta,
)
from fivcplayground.legacies.agents.types.repositories import AgentsRuntimeRepository
...
class TestChatHistory:
    ...
    def test_list_history_loads_tool_calls_for_completed_runtimes(self):
        ...
        from fivcplayground.legacies.agents.types import AgentsRuntimeToolCall
...
class TestChatAsk:
    ...
    async def test_ask_basic_execution(self):
        ...
        with patch(
            "fivcplayground.legacies.app.utils.chats.create_briefing_task"
        ) as mock_briefing_task, patch(
            "fivcplayground.legacies.app.utils.chats.agents.default_retriever.get"
