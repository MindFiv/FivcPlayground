...
Example:
    >>> from fivcadvisor.agents.types.repositories.sqlite import SqliteAgentsRuntimeRepository
    >>> from fivcadvisor.agents.types import AgentsRuntimeMeta, AgentsRuntime
    >>>
    >>> # Create repository
...
from fivcadvisor.agents.types import AgentsRuntimeMeta
