...
class EmbeddingsImpl(IEmbeddingDB):
    ...
    Example:
        ...
        >>> doc = EmbeddingDoc(text="Hello world", metadata={"source": "test"})
        >>> chunk_results = embeddings.add_document(doc)  # Returns list of EmbeddingResult
    ...
    def add_document(self, doc: EmbeddingDoc) -> List[EmbeddingResult]:
        ...
        Args:
            doc: EmbeddingDoc instance containing text and optional metadata

        Returns:
            A list of EmbeddingResult objects, one for each chunk created from the document.
        ...
        try:
            ...
            # Create EmbeddingResult for each chunk
            results = [
                EmbeddingResult(
                    id=chunk_id,
                    text=chunk,
    ...
    def search_documents(
        ...
        Returns:
            An iterable of EmbeddingResult instances with search results
